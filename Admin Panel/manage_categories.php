...
<head>
  ...
  <title>Category Table — Soul Frame Studio</title>
                ...
                <tbody>
					  ...
					  ?>
						...
						<tr>
						  ...
						  <td scope="col" class="px-0"><?php echo $value->CategoryName?></td>
						  <td scope="col" class="px-0"><?php echo $value->Description?></td>
						  <td scope="col" class="px-0"><?php echo $value->CategoryImage?></td>
