...
<head>
  ...
  <title>Add Gallery — Soul Frame Studio</title>
      ...
      <div class="container-fluid py-4">
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title mb-4 text-center text-primary fw-bold">Add Gallery Image</h4>
                ...
                <form action="#" method="post" enctype="multipart/form-data">
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                      ...
                      <input type="date" class="form-control" name="UploadedDate" required>
                    </div>
                  ...
                  <div class="text-center mt-4">
                    <button type="submit" class="btn btn-primary px-4">Add Gallery</button>
